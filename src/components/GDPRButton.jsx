      ...
      {visible && (
        <div className="fixed bottom-4 left-4 right-4 md:bottom-6 text-center md:right-6 md:left-auto max-w-full md:max-w-xs p-4 rounded-lg 
          ...
          <p className="mb-3">
            <a
              href="/privacy-policy"
              className="underline text-green-600 hover:text-green-700 dark:text-green-600 dark:hover:text-green-700"
            >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3">
            <button
              ...
              className="bg-green-600 text-white px-4 py-2 rounded text-sm hover:bg-green-700 dark:hover:bg-green-700 transition"
            >
              Reject
            </button>
            <button
      ...
      {showIcon && !visible && (
        <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-40">
          <button
            ...
            className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-green-600 shadow-lg border border-white 
